...
static const QLatin1String SNOWPLOW_SCHEMA_QEVENT("iglu:io.qt/qevent/jsonschema/1-0-0");
...
static const QLatin1String SETTINGS_USER_ID("userId");
...
public:
    ...
    void trackClickEvent(const QString &name, const QString &category, int x, int y,
                         const std::optional<InsightTracker::ContextData> &context = std::nullopt);
    void trackEvent(const QString &event, const QString &target,
